		...
		<div class="container-custom py-8">
			<div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
				<p class="text-gray-600 text-sm">
					© {new Date().getFullYear()} Wilson Malakkaran. All rights reserved.
				</p>
				<div class="flex space-x-6">
					<a href="https://instagram.com/wilsonmalakkaran" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-gray-900 transition-colors" aria-label="Instagram">
